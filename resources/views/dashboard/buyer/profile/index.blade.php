        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <h5 class="my-2">{{ $buyer->nama }}</h5>
                    <p class="text-muted mb-1">{{ $buyer->user->email }}</p>
                    <p class="text-muted mb-4">
                        Member sejak {{ \Carbon\Carbon::parse($buyer->tanggal_registrasi)->format('d M Y') }}
                    </p>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editProfileModal">
                        <i class="fas fa-edit me-1"></i>fil
                    </button>
                </div>
            </div>
                    ...
                    <div class="row text-center">
                        <div class="col-6">
                            <div class="border-end">
                                <h4 class="text-primary mb-1">{{ $transaksi->count() }}</h4>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">{{ $buyer->nama }}</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">{{ $buyer->user->email }}</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">#{{ str_pad($buyer->pembeli_id, 6, '0', STR_PAD_LEFT) }}</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">
                                {{ \Carbon\Carbon::parse($buyer->tanggal_registrasi)->format('d M Y H:i') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" 
                               value="{{ $buyer->nama }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" class="form-control" id="email" name="email" 
                               value="{{ $buyer->user->email }}" required>
                    </div>
                    <div class="mb-3">
