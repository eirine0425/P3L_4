...
<body>
    <div class="container-fluid">
            ...
            <div class="hunter-section page-break">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        @if(isset($hunterDetails[$hunter->pegawai_id]) && $hunterDetails[$hunter->pegawai_id]->count() > 0)
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        <small>
                            ...
                            Rata-rata waktu jual: {{ $hunterDetails[$hunter->pegawai_id]->avg('hari_terjual') ? number_format($hunterDetails[$hunter->pegawai_id]->avg('hari_terjual'), 1) : '0' }} hari |
                            Item tercepat terjual: {{ $hunterDetails[$hunter->pegawai_id]->min('hari_terjual') ?? '0' }} hari |
                            Item terlama terjual: {{ $hunterDetails[$hunter->pegawai_id]->max('hari_terjual') ?? '0' }} hari
                        </small>
                    </div>
                </div>
                @endif
        ...
        <div class="mt-4" style="font-size: 10px; color: #666;">
            ...
            • Laporan ini menampilkan hunter yang memiliki komisi pada periode yang dipilih
        </div>
    </div>
</body>
</html>
